...
def generate_diff(path_to_file1, path_to_file2):
    with open(path_to_file1, "r") as file1:         #json.load(open(path_to_file1))
...
#print(generate_diff("gendiff_package/scripts/fixtures/file1.json", "gendiff_package/scripts/fixtures/file2.json"))